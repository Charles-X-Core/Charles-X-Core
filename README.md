...
### 🇪🇸 Español
Soy **Carlos Alonso Picho Vargas**, conocido como **CHARLES-X**. Desarrollador de software apasionado por la **inteligencia artificial**, la **automatización** y la **seguridad de redes**.

Me encanta crear soluciones que combinan tecnología de vanguardia con diseño innovador. Desde aplicaciones móviles hasta sistemas de automatización de redes con MCP, siempre busco superar los límites de lo posible.

- 🔥 Full Stack Developer
- 🤖 AI & Automation Enthusiast
- 🛡️ Network Security Researcher
...
> Suite de PDFs cyberpunk oscura con interfaz sarcástica bilingüe ES/EN. Merge/Split/Compress PDFs, Image to PDF, Word to PDF.

[🔗 Ver Repositorio](https://github.com/Charles-X-Core/FakeLove-PDF-Tools) | [🌐 Demo](https://fake-love-pdf-tools.vercel.app)

</td>
<td width="50%">

### 🛡️ Packet Tracer MCP MITM
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python)
![MCP](https://img.shields.io/badge/MCP-FF6B35?style=flat-square)

> Automatización de redes Cisco con MCP y laboratorio de seguridad MITM. Integración con Packet Tracer.

[🔗 Ver Repositorio](https://github.com/Charles-X-Core/packet-tracer-mcp-mitm)
...
> Aplicación de citas creada para Lima. Desarrollada en Kotlin con arquitectura moderna.

[🔗 Ver Repositorio](https://github.com/Charles-X-Core/APP-DATE)
...
> Colección de proyectos prácticos en Microsoft Azure. Despliegues automatizados y scripting.

[🔗 Ver Repositorio](https://github.com/Charles-X-Core/azure-projects-charles)
...
## 💡 Lo que me gusta hacer / What I Love Building

<div align="center">

| Área | Descripción |
|------|-------------|
| 🤖 **AI & Automation** | Sistemas inteligentes, MCP Protocol, automatización de procesos |
| 🛡️ **Network Security** | Laboratorios MITM, ethical hacking, seguridad de redes Cisco |
| 🌐 **Full Stack Web** | Next.js, React, TypeScript, aplicaciones modernas |
| 📱 **Mobile Apps** | Kotlin, Android, experiencias nativas |
| ☁️ **Cloud & DevOps** | Azure, Docker, CI/CD, infraestructura como código |
| 🔧 **IoT & Hardware** | ESP32, Arduino, sistemas embebidos |
...
```javascript
const CharlesX = {
    name: "Carlos Alonso Picho Vargas",
    alias: "CHARLES-X",
    location: "Perú 🇵🇪",
    currentFocus: "AI & Network Automation",
    learning: ["MCP Protocol", "Advanced AI", "Cloud Architecture"],
    askMeAbout: ["TypeScript", "Python", "Kotlin", "AI", "Security", "Azure"],
    funFact: "I code in cyberpunk mode 24/7 🔥"
};
```
...
## 📈 Contribution Graph / Gráfico de Contribuciones
...
<!-- FOOTER -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d0d0d,25:ffa500,50:ff6b35,75:ff4444,100:0d0d0d&height=80&section=footer" width="100%" />
